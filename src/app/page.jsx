    ...
    return (
        <>
            ...
            <div className={styles.main}>
                <img src="/images/hp-big.webp" alt="Homepage Big" />
                <div className={styles.icons}>
                  {/* <div className={styles.contain}>
                    <img src="/images/icons/image.png" alt="Icon 1" />
                    <img src="/images/icons/Capture.PNG" alt="Icon 2" />
                    <img src="/images/icons/Capture-otherAnimals.PNG" alt="Icon 3" />
                </div> */}
                </div>
            </div>
            <div>
                    ...
                    {pets.map((pet, index) => (
                        <div key={index} className={styles.item}>
                          <div className={styles.seperate}>
                              <div className={styles.title1}><h2>{pet.title}</h2></div>
                            ...
                            <Image src={pet.image} alt={pet.name} width={300} height={200} objectFit="cover" className={styles.imageContainer}/>
